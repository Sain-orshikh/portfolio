...
export const projects: Project[] = [
  {
    ...
    repo: 'https://github.com/Sain-orshikh/nyxedu', // Add your GitHub link later
  ...
  },
  {
    ...
    tech: ['GraphQL', 'Next.js', 'Erxes', 'Payment Integration', 'Booking System'],
  ...
  },
  {
    ...
    tech: ['GraphQL', 'Next.js', 'Erxes', 'CRM', 'Form Builder'],
    repo: '', // Add your GitHub link later
  ...
  {
    id: 'proj-5',
    title: 'Study Simple Platform',
    description: 'Transformed a Notion-based no-code website into a production-ready Next.js application. Improved performance, maintainability, and user experience for the school club.',
    tech: ['Next.js', 'TypeScript', 'CMS', 'Migration'],
    repo: 'https://github.com/Sain-orshikh/study-simple-web', // Add your GitHub link later
    demo: 'https://www.studysimple.org/',
    image: '/studysimple.webp'
  },
  {
    id: 'proj-6',
    title: 'Twitter Clone',
    description: 'Full-featured social media platform inspired by Twitter. Implemented real-time updates, user authentication, posts, likes, and follows. Built to learn modern web development patterns.',
    tech: ['MongoDB', 'Javascript', 'Rest API', 'Authentication', 'Real-time'],
    repo: 'https://github.com/Sain-orshikh/twitter-clone', // Add your GitHub link later
    demo: '',
    image: '/twitterclone.webp'
  },
  {
    id: 'proj-7',
    title: 'Rock Paper Scissors (Django)',
    description: 'My first web development project that sparked my interest in web development. Simple game built with Django to learn the fundamentals of backend and frontend integration.',
    tech: ['Python', 'Django', 'HTML', 'CSS', 'JavaScript'],
    repo: 'https://github.com/Sain-orshikh/RPS', // Add your GitHub link later
    demo: '',
    image: '/rps.webp',
  },
    {
    ...
    tech: ['Python', 'Pygame'],
    repo: 'https://github.com/Sain-orshikh/Runner',
    demo: '',
    image: '/runner.webp',
  },
  {
